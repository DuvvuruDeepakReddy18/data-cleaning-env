@echo off
echo ============================================
echo Running HARD task only (Qwen 3.6 Plus FREE)
echo ============================================
...
python inference.py --env-url https://Deepak1819-data-cleaning-env.hf.space --task hard_sales_reconciliation

echo ============================================
echo Hard task complete! Check results.json
echo ============================================
pause
